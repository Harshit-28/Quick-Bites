...
export default function UserLandingPage({ setEmail }) {  // Receive setEmail as a prop
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isRegister) {
        ...
        // Update the email in localStorage and also in the App's state using setEmail
        localStorage.setItem("email", formData.email);
        localStorage.setItem("token", response.token);  // Assuming a token is returned
        setEmail(formData.email);  // Update the parent component's state with the email
